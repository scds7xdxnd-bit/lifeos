...
/**
 * Botanical illustration for the hero section.
 * Uses the canonical green palette from DESIGN.md.
 */
export const LifeIllustration = () => (
  ...
  >
    {/* Ground line */}
    <path
      d="M15 240 Q130 200 260 216 Q385 232 505 190"

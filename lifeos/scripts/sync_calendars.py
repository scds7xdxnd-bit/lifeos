...
@click.option(
    "--provider",
    "-p",
    type=click.Choice(["google", "apple", "all"]),
    default="all",
    ...
    if user:
        ...
        if provider in ("google", "all"):
            ...
            try:
                ...
                click.echo(
                    f"  ✓ Google: Created {stats['created']}, Updated {stats['updated']}, Deleted {stats['deleted']}"
                )
        ...
        if provider in ("apple", "all"):
            ...
            try:
                ...
                click.echo(
                    f"  ✓ Apple: Created {stats['created']}, Updated {stats['updated']}, "

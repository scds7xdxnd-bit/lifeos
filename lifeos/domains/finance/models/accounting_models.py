...
class AccountCategory(db.Model):
    ...
    normal_balance: Mapped[str] = mapped_column(
        db.String(8), nullable=False, default="debit"
    )
...
class Account(db.Model):
    ...
    __table_args__ = (
        ...
        db.Index(
            "ix_finance_account_user_normalized_name", "user_id", "normalized_name"
        ),
    ...
    category_id: Mapped[int | None] = mapped_column(
        db.ForeignKey("finance_account_category.id"), nullable=True
    )
    ...
    account_type: Mapped[str] = mapped_column(
        db.String(16), nullable=False, default="asset", index=True
    )
...
class JournalEntry(db.Model):
    ...
    __table_args__ = (
        db.Index("ix_finance_journal_entry_user_posted_at", "user_id", "posted_at"),
    )
...
class JournalLine(db.Model):
    ...
    entry_id: Mapped[int] = mapped_column(
        db.ForeignKey("finance_journal_entry.id"), index=True, nullable=False
    )
    account_id: Mapped[int] = mapped_column(
        db.ForeignKey("finance_account.id"), index=True, nullable=False
    )
...
class Transaction(db.Model):
    ...
    journal_entry_id: Mapped[int | None] = mapped_column(
        db.ForeignKey("finance_journal_entry.id")
    )

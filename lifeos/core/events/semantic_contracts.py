...
EVENT_SEMANTIC_CONTRACTS: dict[str, EventSemanticContract] = {
    ...
    "finance.account.updated": EventSemanticContract(
        event_type="finance.account.updated",
        meaning="A financial account was updated.",
        asserted_by="user",
        certainty="confirmed",
    ),
    "finance.account.deactivated": EventSemanticContract(
        event_type="finance.account.deactivated",
        meaning="A financial account was deactivated.",
        asserted_by="user",
        certainty="confirmed",
    ),
    ...
    "finance.accounts.seeded": EventSemanticContract(
        event_type="finance.accounts.seeded",
        meaning="A default chart of accounts was seeded for a user.",
        asserted_by="system",
        certainty="confirmed",
    ),
    "finance.exchange_rate.set": EventSemanticContract(
        event_type="finance.exchange_rate.set",
        meaning="A manual exchange rate was created or updated.",
        asserted_by="user",
        certainty="confirmed",
    ),
    ...
    "finance.transaction.edited": EventSemanticContract(
        event_type="finance.transaction.edited",
        meaning="A financial transaction's metadata was edited.",
        asserted_by="user",
        certainty="confirmed",
    ),
    "finance.transaction.voided": EventSemanticContract(
        event_type="finance.transaction.voided",
        meaning="A financial transaction was voided and reversed.",
        asserted_by="user",
        certainty="confirmed",
    ),

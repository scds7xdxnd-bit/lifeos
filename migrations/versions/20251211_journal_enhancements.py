...
def upgrade():
    ...
    op.add_column("journal_entry", sa.Column("tags", sa.JSON(), nullable=False, server_default=sa.text("'[]'")))
    op.add_column("journal_entry", sa.Column("entry_date", sa.Date(), nullable=False, server_default=sa.func.current_date()))
    op.add_column("journal_entry", sa.Column("is_private", sa.Boolean(), nullable=False, server_default=sa.true()))
    ...
    op.add_column("journal_entry", sa.Column("updated_at", sa.DateTime(), nullable=False, server_default=sa.func.now()))
